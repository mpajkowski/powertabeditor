...
public:
    // Default constants
    static const uint16_t DEFAULT_SYSTEM; ///< Default value for the system
                                          ///< member variable
    static const uint8_t DEFAULT_STAFF; ///< Default value for the staff member
                                        ///< variable
    static const uint8_t DEFAULT_POSITION; ///< Default value for the position
                                           ///< member variable
    static const uint16_t DEFAULT_DATA; ///< Default value for the data member
                                        ///< variable
    static const uint8_t DEFAULT_STAFF_VOLUME; ///< Default value for the staff
                                               ///< volume
    static const uint8_t DEFAULT_RHYTHM_SLASH_VOLUME; ///< Default value for the
                                                      ///< dynamic volume

    // System Constants
    static const uint32_t MIN_SYSTEM; ///< Minimum allowed value for the system
                                      ///< member variable
    static const uint32_t MAX_SYSTEM; ///< Maximum allowed value for the system
                                      ///< member variable

    // Staff Constants
    static const uint32_t MIN_STAFF; ///< Minimum allowed value for the staff
                                     ///< member variable
    static const uint32_t MAX_STAFF; ///< Maximum allowed value for the staff
                                     ///< member variable
    ...
    // Member Variables
private:
    uint16_t m_system; ///< Zero-based index of the system where the dynamic is
                       ///< anchored
    uint8_t m_staff; ///< Zero-based index of the staff within the system where
                     ///< the dynamic is anchored
    uint8_t m_position; ///< Zero-based index of the position within the system
                        ///< where the dynamic is anchored
    uint16_t m_data; ///< Volume level (see volumeLevels enum for values; top
                     ///< byte = staff volume, bottom byte = dynamic volume)
