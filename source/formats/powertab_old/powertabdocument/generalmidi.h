...
const uint32_t MIDI_PPQN =
    MIDI_QUARTER; // MIDI PPQN = amount of "MIDI time" per quarter note

// MIDI Channel constants
const uint8_t NUM_MIDI_CHANNELS_PER_PORT =
    16; ///< Number of MIDI channels per port
const uint8_t FIRST_MIDI_CHANNEL = 0; ///< First MIDI channel
const uint8_t LAST_MIDI_CHANNEL = 15; ///< Last MIDI channel

const uint8_t MIN_MIDI_CHANNEL_VOLUME =
    0; ///< Minimum volume level for a MIDI channel
const uint8_t MAX_MIDI_CHANNEL_VOLUME =
    0x7f; ///< Maximum volume level for a MIDI channel

const uint8_t MIN_MIDI_CHANNEL_EFFECT_LEVEL =
    0; ///< Miniumum level for channel effects (chorus, reverb, etc.)
const uint8_t MAX_MIDI_CHANNEL_EFFECT_LEVEL =
    0x7f; ///< Maximum level for channel effects (chorus, reverb, etc.)
...
const uint8_t MIN_MIDI_NOTE_VOLUME =
    0; ///< Minimum volume level for a MIDI note
const uint8_t MAX_MIDI_NOTE_VOLUME =
    0x7f; ///< Maximum volume level for a MIDI note
