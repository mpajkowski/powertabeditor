...
public:
    // Default Constants
    static const uint8_t DEFAULT_STRING_DATA; ///< Default value for the string
                                              ///< data member variable
    static const uint16_t DEFAULT_SIMPLE_DATA; ///< Default value for the simple
                                               ///< data member variable
    ...
    // Bend Constants
    static const uint8_t MAX_BEND_PITCH; ///< Maximum allowed pitch for a bend,
                                         ///< in quarter steps
    static const uint8_t MAX_BEND_DURATION; ///< Maximum allowed value for the
                                            ///< bend duration

    static const size_t MAX_NOTE_COMPLEX_SYMBOLS =
        3; ///< Maximum allowed number of complex symbols per note object
    ...
    enum simpleFlags
    {
        ...
        hammerPullMask = 0x38, ///< Mask that filters out mutually exclusive
                               ///< hammer on/pull off flags
        ...
        octave15mb = 0x800,
        octaveMask =
            0xf00, ///< Mask that filters out mutually exclusive octave flags
        simpleFlagsMask =
            0xfff ///< Mask that filters out all possible simple flags
    };
    ...
    enum slideIntoTypes
    {
        ...
        slideIntoShiftSlideUpwards =
            0x03, ///< Used for wrapping shift slides around systems
        slideIntoShiftSlideDownwards =
            0x04, ///< Used for wrapping shift slides around systems
        slideIntoLegatoSlideUpwards =
            0x05, ///< Used for wrapping legato slides around systems
        slideIntoLegatoSlideDownwards =
            0x06 ///< Used for wrapping legato slides around systems
    };
    ...
    {
        slideIntoTypeMask =
            0xff0000, ///< Mask used to retrieve the slide into type
        slideOutOfTypeMask =
            0xff00, ///< Mask used to retrieve the slide out of type
        slideOutOfStepsMask =
            0xff ///< Mask used to retrieve the slide out of steps
    };
    ...
    enum bendFlags
    {
        ...
        releasePitchMask =
            0xf ///< Mask used to retrieve the release pitch value
    };
...
private:
    ...
    std::array<uint32_t, MAX_NOTE_COMPLEX_SYMBOLS>
        m_complexSymbolArray; ///< Complex symbol data (1 symbol per element)
...
public:
    inline bool HasLegatoSlide() const
    {
        return HasSlideOutType(slideOutOfLegatoSlide);
    }
    inline bool HasShiftSlide() const
    {
        return HasSlideOutType(slideOutOfShiftSlide);
    }
