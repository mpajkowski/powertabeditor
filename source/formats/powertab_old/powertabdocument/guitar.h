...
public:
    // Default constants
    static const uint8_t DEFAULT_NUMBER; ///< Default value for the number
                                         ///< member variable
    static const std::string DEFAULT_DESCRIPTION; ///< Default value for the
                                                  ///< description member
                                                  ///< variable
    static const uint8_t DEFAULT_PRESET; ///< Default value for the preset
                                         ///< member variable
    static const uint8_t DEFAULT_INITIAL_VOLUME; ///< Default value for the
                                                 ///< intial volume member
                                                 ///< variable
    static const uint8_t DEFAULT_PAN; ///< Default value for the pan member
                                      ///< variable
    static const uint8_t DEFAULT_REVERB; ///< Default value for the reverb
                                         ///< member variable
    static const uint8_t DEFAULT_CHORUS; ///< Default value for the chorus
                                         ///< member variable
    static const uint8_t DEFAULT_TREMOLO; ///< Default value for the tremolo
                                          ///< member variable
    static const uint8_t DEFAULT_PHASER; ///< Default value for the phaser
                                         ///< member variable
    static const uint8_t DEFAULT_CAPO; ///< Default value for the capo member
                                       ///< variable
    ...
    static const uint8_t MIN_INITIAL_VOLUME; ///< Minimum allowed value for the
                                             ///< initial volume
    static const uint8_t MAX_INITIAL_VOLUME; ///< Maximum allowed value for the
                                             ///< initial volume
    ...
    static const uint8_t PAN_CENTER; ///< Value for the center/middle pan
                                     ///< setting
    static const uint8_t PAN_HARD_RIGHT; ///< Value for the hard right pan
                                         ///< setting

    static const uint8_t MIN_REVERB; ///< Minimum allowed value for the reverb
                                     ///< level
    static const uint8_t MAX_REVERB; ///< Maximum allowed value for the reverb
                                     ///< level

    static const uint8_t MIN_CHORUS; ///< Minimum allowed value for the chorus
                                     ///< level
    static const uint8_t MAX_CHORUS; ///< Maximum allowed value for the chorus
                                     ///< level

    static const uint8_t MIN_TREMOLO; ///< Minimum allowed value for the tremolo
                                      ///< level
    static const uint8_t MAX_TREMOLO; ///< Maximum allowed value for the tremolo
                                      ///< level

    static const uint8_t MIN_PHASER; ///< Minimum allowed value for the phaser
                                     ///< level
    static const uint8_t MAX_PHASER; ///< Maximum allowed value for the phaser
                                     ///< level

    static const uint8_t MIN_CAPO; ///< Minimum allowed value for the capo
                                   ///< number
    static const uint8_t MAX_CAPO; ///< Maximum allowed value for the capo
                                   ///< number

    // Member Variables
private:
    uint8_t m_number; ///< Unique number used to identify the guitar
                      ///< (zero-based)
    std::string m_description; ///< Description of the guitar
    uint8_t m_preset; ///< MIDI preset to use during playback
    uint8_t m_initialVolume; ///< Initial MIDI channel volume level for the
                             ///< guitar
