...
public:
    ...
    // Member Variables
private:
    uint16_t m_system; ///< Zero-based index of the system where the guitar in
                       ///< is anchored
    ...
    uint8_t m_position; ///< Zero-based index of the position within the system
                        ///< where the guitar in is anchored
    uint16_t m_data; ///< Bit map representing the guitar number of the active
                     ///< guitars (bit 1 = guitar 0, bit 2 = guitar 1, etc.)
                     ///< High byte = staff guitars, low byte = rhythm slash
                     ///< guitars
