...
public:
    // Constants
    // Default Constants
    static const uint8_t DEFAULT_TOP_FRET; ///< Default value for the top fret
                                           ///< member variable

    // Top Fret Constants
    static const uint8_t MIN_TOP_FRET; ///< Minimum allowed value for the top
                                       ///< fret member variable
    static const uint8_t MAX_TOP_FRET; ///< Maximum allowed value for the top
                                       ///< fret member variable
