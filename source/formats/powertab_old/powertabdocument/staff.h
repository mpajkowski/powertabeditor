...
public:
    ...
    static const uint8_t DEFAULT_TABLATURE_STAFF_TYPE; ///< Default tablature
                                                       ///< staff type
    static const uint8_t
        DEFAULT_STANDARD_NOTATION_STAFF_ABOVE_SPACING; ///< Default value for
                                                       ///< the standard
                                                       ///< notation staff above
                                                       ///< spacing member
                                                       ///< variable
    static const uint8_t
        DEFAULT_STANDARD_NOTATION_STAFF_BELOW_SPACING; ///< Default value for
                                                       ///< the standard
                                                       ///< notation staff below
                                                       ///< spacing member
                                                       ///< variable
    static const uint8_t DEFAULT_SYMBOL_SPACING; ///< Default value for the
                                                 ///< symbol spacing member
                                                 ///< variable
    static const uint8_t
        DEFAULT_TABLATURE_STAFF_BELOW_SPACING; ///< Default value for the
                                               ///< tablature staff below
                                               ///< spacing member variable
    static const uint8_t STD_NOTATION_LINE_SPACING;
    static const uint8_t STD_NOTATION_STAFF_TYPE;
    static const uint8_t STAFF_BORDER_SPACING; /// padding around top and bottom
                                               /// of staves
    static const uint8_t TAB_SYMBOL_HEIGHT; /// height allocated for drawing a
                                            /// tab symbol
    ...
    static const uint8_t MIN_TABULATURE_STAFF_TYPE; ///< Minimum allowed value
                                                    ///< for tablature staff
                                                    ///< type
    static const uint8_t MAX_TABULATURE_STAFF_TYPE; ///< Maximum allowed value
                                                    ///< for tablature staff
                                                    ///< type
    ...
    enum flags
    {
        ...
        tablatureStaffTypeMask =
            0xf ///< Mask used to retrieve the tablature type (3 - 7 string)
    };
...
private:
    ...
    uint8_t m_standardNotationStaffAboveSpacing; ///< Amount of space alloted
                                                 ///< from the top line of the
                                                 ///< standard notation staff
    uint8_t m_standardNotationStaffBelowSpacing; ///< Amount of space alloted
                                                 ///< from the last line of the
                                                 ///< standard notation staff
    uint8_t m_symbolSpacing; ///< Amount of space alloted for symbols located
                             ///< between the standard notation and tablature
                             ///< staff
    uint8_t m_tablatureStaffBelowSpacing; ///< Amount of space alloted from the
                                          ///< last line of the tablature staff
    bool m_isShown;

public:
    std::array<std::vector<Position *>, NUM_STAFF_VOICES>
        positionArrays; ///< collection of position arrays, one per voice
