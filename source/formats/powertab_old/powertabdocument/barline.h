...
public:
    ...
    static const uint8_t MIN_REPEAT_COUNT; ///< Minimum allowed value for the
                                           ///< repeat count
    static const uint8_t MAX_REPEAT_COUNT; ///< Maximum allowed value for the
                                           ///< repeat count
    ...
    enum flags
    {
        ...
        repeatCountMask =
            (uint8_t)0x1f ///< Mask used to retrieve the repeat count
    };

    // Member Variables
private:
    uint8_t m_position; ///< Zero-based index of the position within the system
                        ///< where the barline is anchored
