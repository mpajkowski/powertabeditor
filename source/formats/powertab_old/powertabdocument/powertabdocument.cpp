...
/// @return The amount of fade in at the start of the song or lesson, in MIDI
...
bool Document::IsValidTablatureStaffLineSpacing(
...
{
    PTB_CHECK_THAT(IsValidTablatureStaffLineSpacing(tablatureStaffLineSpacing),
                   false);
