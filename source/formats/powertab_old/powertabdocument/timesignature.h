...
public:
    ...
    static const uint32_t DEFAULT_DATA; ///< Default value for the data member
                                        ///< variable
    static const uint8_t DEFAULT_PULSES; ///< Default value for the pulses data
                                         ///< member variable

    static const uint8_t MIN_BEATSPERMEASURE; ///< Minimum allowed value for
                                              ///< beats per measure
    static const uint8_t MAX_BEATSPERMEASURE; ///< Maximum allowed value for
                                              ///< beats per measure

    static const uint8_t MIN_BEATAMOUNT; ///< Minimum allowed value for the beat
                                         ///< amount
    static const uint8_t MAX_BEATAMOUNT; ///< Maximum allowed value for the beat
                                         ///< amount
    ...
    {
        meterMask =
            (uint32_t)0xff000000, ///< Bit mask used to retrieve the meter
        beatsPerMeasureMask =
            (uint32_t)0xf8000000, ///< Bit mask used to retrieve the beats per
                                  ///< measure value
        beatAmountMask = (uint32_t)0x07000000, ///< Bit mask used to retrieve
                                               ///< the beat amount value
        beamingPatternMask = (uint32_t)0xfffff, ///< Bit mask used to retrieve
                                                ///< the beaming pattern
        beamingPatternBeat1Mask =
            (uint32_t)0xf8000, ///< Bit mask used to retrieve beat 1 of the
                               ///< beaming pattern
        beamingPatternBeat2Mask =
            (uint32_t)0x7c00, ///< Bit mask used to retrieve beat 2 of the
                              ///< beaming pattern
        beamingPatternBeat3Mask =
            (uint32_t)0x3e0, ///< Bit mask used to retrieve beat 3 of the
                             ///< beaming pattern
        beamingPatternBeat4Mask =
            (uint32_t)0x1f, ///< Bit mask used to retrieve beat 4 of the beaming
                            ///< pattern
        show = (uint32_t)0x100000, ///< Show the time signature
        brackets =
            (uint32_t)0x200000, ///< Place brackets around the time signature
    ...
    // Member Variables
private:
    uint32_t m_data; ///< Stores the meter, beaming pattern and any flags (see
                     ///< flags enum for bit breakdown)
