/////////////////////////////////////////////////////////////////////////////
// Name:            fontsetting.h
// Purpose:         Stores information about a font format (facename, point
// size, weight, style, etc.) Author:          Brad Larsen Modified by: Created:
// Dec 5, 2004 RCS-ID: Copyright:       (c) Brad Larsen License: wxWindows
// license
/////////////////////////////////////////////////////////////////////////////
...
FontSetting::FontSetting()
    : m_faceName(DEFAULT_FACENAME),
      ...
      m_italic(DEFAULT_ITALIC),
      m_underline(DEFAULT_UNDERLINE),
      m_strikeOut(DEFAULT_STRIKEOUT),
...
FontSetting::FontSetting(const char *faceName, int32_t pointSize,
                         int32_t weight, bool italic, bool underline,
                         bool strikeOut, Colour color)
    : m_faceName(faceName),
...
bool FontSetting::operator==(const FontSetting &fontSetting) const
{
    //------Last Checked------//
    // - Dec 6, 2004
    return ((m_faceName == fontSetting.m_faceName) &&
            (m_pointSize == fontSetting.m_pointSize) &&
            (m_weight == fontSetting.m_weight) &&
            (m_italic == fontSetting.m_italic) &&
            (m_underline == fontSetting.m_underline) &&
