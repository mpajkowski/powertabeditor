...
public:
    // Default constants
    static const char *DEFAULT_FACENAME; ///< Default value for the face name
                                         ///< member variable
    static const int32_t DEFAULT_POINTSIZE; ///< Defualt value for the point
                                            ///< size member variable
    static const int32_t DEFAULT_WEIGHT; ///< Defualt value for the weight
                                         ///< member variable
    static const bool DEFAULT_ITALIC; ///< Default value for the italic member
                                      ///< variable
    static const bool DEFAULT_UNDERLINE; ///< Default value for the underline
                                         ///< member variable
    static const bool DEFAULT_STRIKEOUT; ///< Default value for the strikeout
                                         ///< member variable
    static const Colour DEFAULT_COLOR; ///< Default value for the color member
                                       ///< variable

    // Point Size constants
    static const int32_t MIN_POINTSIZE; ///< Minimum allowed value for the point
                                        ///< size member variable
    static const int32_t MAX_POINTSIZE; ///< Maximum allowed value for the point
                                        ///< size member variable
    ...
    // Member Variables
private:
    std::string m_faceName; ///< Face name of the font; i.e. Arial, Times New
                            ///< Roman, etc.
...
public:
    ...
    // Data Functions
public:
    bool SetFontSetting(const char *faceName, int32_t pointSize, int32_t weight,
