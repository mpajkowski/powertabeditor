...
public:
    // Default constants
    static const char *DEFAULT_TEXT; ///< Default value for the text member
                                     ///< variable
    static const Rect DEFAULT_RECT; ///< Default value for the rect member
                                    ///< variable
    static const uint8_t DEFAULT_FLAGS; ///< Default value for the flags member
                                        ///< variable
...
private:
    ...
    uint8_t m_flags; ///< Flags representing alignment and borders (see flags
                     ///< below)
    FontSetting m_fontSetting; ///< Font setting (format) to use when drawing
                               ///< the text
