...
public:
    ...
    static const int32_t
        DEFAULT_TABLATURE_STAFF_LINE_SPACING; ///< Default value for the
                                              ///< tablature staff line spacing
                                              ///< member variable
    static const uint32_t DEFAULT_FADE_IN; ///< Default value for the fade in
                                           ///< member variable
    static const uint32_t DEFAULT_FADE_OUT; ///< Default value for the fade out
                                            ///< member variable

    // Tablature Staff Line Spacing Constants
    static const int32_t MIN_TABLATURE_STAFF_LINE_SPACING; ///< Minimum allowed
                                                           ///< value for the
                                                           ///< tablature staff
                                                           ///< line spacing
                                                           ///< member variable
    static const int32_t MAX_TABLATURE_STAFF_LINE_SPACING; ///< Maximum allowed
                                                           ///< value for the
                                                           ///< tablature staff
                                                           ///< line spacing
                                                           ///< member variable
    ...
    // Guitar Constants
    static const uint8_t MAX_GUITARS; ///< Maximum number of guitars allowed per
                                      ///< document

    enum
    {
        FONT_SETTING_CHORD_NAME, ///< Font used to draw the chord name (chord
                                 ///< text)
        FONT_SETTING_TABLATURE_NUMBERS, ///< Font used to draw the fret numbers
    ...
    // Member Variables
private:
    PowerTabFileHeader m_header; ///< The one and only header (contains file
                                 ///< information)
    std::vector<Score *> m_scoreArray; ///< List of scores (zeroth element =
                                       ///< guitar score, first element = bass
                                       ///< score)

    std::array<FontSetting, NUM_FONT_SETTINGS> m_fontSettings; ///< List of
                                                               ///< global font
                                                               ///< settings
    int32_t m_tablatureStaffLineSpacing; ///< Amount of space used between lines
                                         ///< on the tablature staff
    uint32_t m_fadeIn; ///< Amount of fade in at the start of the song (in MIDI
                       ///< units - see generalmidi.h)
    uint32_t m_fadeOut; ///< Amount of fade out at the end of the song (in MIDI
                        ///< units - see generalmidi.h)
