...
void ScorePage::createSectionButtons()
{
    ...
    connectButtonToAction(increaseWidthButton,
                          mainWindow->increasePositionSpacingAct);
    ...
    connectButtonToAction(decreaseWidthButton,
                          mainWindow->decreasePositionSpacingAct);
...
ScorePage::ScorePage(PowerTabEditor *mainWindow,
                     boost::shared_ptr<SkinManager> skinManager, QFrame *parent)
    : QFrame(parent), mainWindow(mainWindow)
{
