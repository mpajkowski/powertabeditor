...
void NotePage::createRhythmButtons()
{
    ...
    doubleDottedButton =
        new QPushButton(QIcon(":images/doubledotted_note"), "");
    ...
    connect(doubleDottedButton, SIGNAL(pressed()), this,
            SLOT(resetDottedButtons()));
...
void NotePage::createSlideLegatoButtons()
{
    ...
    connectButtonToAction(slideInBelowButton,
                          mainWindow->slideIntoFromBelowAct);
    ...
    connectButtonToAction(slideInAboveButton,
                          mainWindow->slideIntoFromAboveAct);
    ...
    connectButtonToAction(slideOutBelowButton,
                          mainWindow->slideOutOfDownwardsAct);
    ...
    connectButtonToAction(slideOutAboveButton,
                          mainWindow->slideOutOfUpwardsAct);
...
NotePage::NotePage(PowerTabEditor *mainWindow,
